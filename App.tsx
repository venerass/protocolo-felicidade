...
const App: React.FC = () => {
      ...
      if (currentUser) {
        ...
        try {
          ...
          if (data) {
            ...
            // Auto-sync habits with latest library versions
            // This runs silently in the background and preserves user's progress
            try {
              ...
              console.warn('⚠️ Falha ao sincronizar hábitos, usando versão atual:', syncError);
  ...
  // Reset to onboarding - clears habits & profile, keeps all logs (historical data)
