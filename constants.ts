...
export const HABIT_LIBRARY: Omit<Habit, 'enabled' | 'streak'>[] = [
  ...
  },
  {
    ...
    targetCount: 2,
    unit: 'max_x',
    description: 'Máximo 2 ocasiões',
    timeOfDay: 'any',
    weight: 1 // Low
  },
  {
    id: 'limit_cannabis',
    title: 'Limite Cannabis',
    category: Category.VICIOS,
    frequencyType: FrequencyType.WEEKLY,
    targetCount: 2,
    unit: 'max_x',
    description: 'Máximo 2 usos',
    timeOfDay: 'any',
    weight: 1 // Low
  },
  {
    ...
    targetCount: 1,
    unit: 'max_x',
    description: 'Max 1x (4h)',
    timeOfDay: 'any',
    weight: 3 // High
  },
  {
    id: 'limit_shorts',
    title: 'Limite Reels/TikTok',
    category: Category.VICIOS,
    frequencyType: FrequencyType.WEEKLY,
    targetCount: 2,
    unit: 'max_x',
    description: 'Apenas Fim de Semana',
    timeOfDay: 'any',
    weight: 3 // High
  },
  {
    id: 'limit_yt',
    title: 'Limite YouTube',
    category: Category.VICIOS,
    frequencyType: FrequencyType.DAILY,
    targetCount: 1,
    unit: 'bool',
    description: 'Apenas almoço/pós-trabalho',
    timeOfDay: 'any',
    weight: 2 // Medium
  },
  {
